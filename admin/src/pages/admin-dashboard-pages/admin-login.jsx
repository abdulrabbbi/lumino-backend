                ...
                <div className="w-full max-w-md space-y-6">
                    <div className="space-y-6">
                        <div className="text-left">
                            <h1 className="text-4xl poppins-700 text-[#000000] mb-2">Admin Sign In</h1>
                            <p className="text-[#000000] text-sm inter-tight-400">Sign in with admin account</p>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative mt-2">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <Key className="h-5 w-5 text-[#000000]" />
                                </div>
                                <input
                                    type="password"
                            ...
                            <button
                                ...
                                disabled={!email || !password || !adminSecretKey || loading}
